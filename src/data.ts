...
export const INITIAL_PENGATURAN: PengaturanSistem = {
  ...
  namaInstansi: "Badan Kesatuan Bangsa dan Politik (Kesbangpol) Kabupaten Bekasi",
  ...
  alamatInstansi: "Jl. Komplek Perkantoran Pemerintah Daerah No. 1, Cikarang Pusat, Bekasi",
  kabupatenDaftar: ["Kabupaten Bekasi", "Kota Bekasi"],
  kecamatanDaftar: [
    "Cikarang Pusat", "Cikarang Utara", "Cikarang Selatan", "Cikarang Barat", "Cikarang Timur",
    "Cibitung", "Tambun Selatan", "Tambun Utara", "Babelan", "Tarumajaya", "Sukatani", 
    "Serang Baru", "Setu", "Muaragembong", "Cabangbungin", "Pebayuran", "Kedungwaringin"
  ],
  tipeDokumenDaftar: [
...
export const INITIAL_PARTAI: Partai[] = [
  {
    ...
    nomorUrut: 3,
    logo: "🔴",
    alamatKantor: "Jl. Sultan Agung No. 25, Cikarang Utara",
    provinsi: "Jawa Barat",
    ...
    email: "kab-bekasi@pdiperjuangan.id",
    ...
    namaBank: "Bank BJB Cabang Cikarang",
    nomorRekening: "0012233445566",
    atasNamaRekening: "DPC PDI Perjuangan Kabupaten Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 2,
    logo: "🦅",
    alamatKantor: "Jl. Tarumajaya Raya No. 45, Tambun Selatan",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    ...
    email: "gerindra.bekasikab@gmail.com",
    website: "gerindra.id",
    statusAktif: true,
    ...
    namaBank: "Bank Mandiri Cikarang",
    nomorRekening: "1560012345678",
    atasNamaRekening: "DPC Partai Gerindra Kab Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 4,
    logo: "🌳",
    alamatKantor: "Jl. Achmad Yani No. 12, Cikarang Pusat",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    ...
    email: "golkar.bekasikab@yahoo.com",
    website: "golkar.id",
    statusAktif: true,
    ...
    namaBank: "Bank BJB Cikarang",
    nomorRekening: "0023344556677",
    atasNamaRekening: "DPD Golkar Kab Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 8,
    logo: "🟠",
    alamatKantor: "Jl. KH. Noer Ali No. 88, Cibitung",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    kecamatan: "Cibitung",
    kelurahan: "Wanasari",
    ...
    namaBank: "Bank Syariah Indonesia Cikarang",
    nomorRekening: "7102233445",
    atasNamaRekening: "DPD PKS Kabupaten Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 1,
    logo: "🟢",
    alamatKantor: "Jl. Industri No. 100, Cikarang Selatan",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    ...
    email: "pkb.kab.bekasi@gmail.com",
    website: "pkb.id",
    statusAktif: true,
    ...
    atasNamaRekening: "DPC PKB Kabupaten Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 14,
    logo: "🔵",
    alamatKantor: "Jl. Gatot Subroto No. 45, Cikarang Utara",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    kecamatan: "Cikarang Utara",
    ...
    email: "demokrat.kab.bekasi@yahoo.co.id",
    ...
    atasNamaRekening: "DPC Partai Demokrat Kab Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 12,
    logo: "☀️",
    alamatKantor: "Jl. Setu Raya No. 120, Setu",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    kecamatan: "Setu",
    ...
    atasNamaRekening: "DPD PAN Kabupaten Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 5,
    logo: "🔵☀️",
    alamatKantor: "Jl. KH. Fudholi No. 90, Cikarang Utara",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    kecamatan: "Cikarang Utara",
    kelurahan: "Karangasih",
    ...
    email: "nasdem.bekasikab@nasdem.id",
    website: "nasdem.id",
    statusAktif: true,
    ...
    atasNamaRekening: "DPD NasDem Kab Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 17,
    logo: "🟢🕋",
    alamatKantor: "Jl. RE Martadinata No. 50, Cikarang Utara",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    kecamatan: "Cikarang Utara",
    kelurahan: "Cikarang Kota",
    ...
    atasNamaRekening: "DPC PPP Kabupaten Bekasi",
  ...
  },
  {
    ...
    nomorUrut: 15,
    logo: "🔴🌹",
    alamatKantor: "Ruko Thamrin Boulevard Block B No. 3, Cikarang Selatan",
    provinsi: "Jawa Barat",
    kabupatenKota: "Kabupaten Bekasi",
    kecamatan: "Cikarang Selatan",
    kelurahan: "Cibatu",
    ...
    atasNamaRekening: "DPD PSI Kabupaten Bekasi",
...
export const INITIAL_PENGGUNA: Pengguna[] = [
  {
    ...
    email: "bambang.admin@bekasikab.go.id",
    role: "Super Admin",
    status: "Aktif",
  ...
  },
  {
    ...
    email: "juhanda.kesbang@bekasikab.go.id",
    role: "Admin Kesbangpol",
    status: "Aktif",
  ...
  },
  {
    ...
    email: "randi.hermawan@bekasikab.go.id",
    role: "Verifikator",
    status: "Aktif",
  ...
  },
  {
    ...
    email: "helmi@gerindrabekasi.or.id",
    role: "Operator Partai",
    status: "Aktif",
    partaiId: "p2",
  ...
  },
  {
    ...
    email: "enunsarji@bekasikab.go.id",
    role: "Pimpinan",
    status: "Aktif",
